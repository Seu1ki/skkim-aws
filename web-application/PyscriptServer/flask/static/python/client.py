...
def set_weather():
    ...
    #div_plt_image = document.getElementById('plt_image')
    ...
    div_forecast.innerText = str(forecast.report_summary)
    div_temp.innerText = str(forecast.temp) + " °C"
    #div_image.setAttribute('src', '/static/images/weather/NanumGothic.ttf')
    div_image.setAttribute('src', '/static/images/weather/{}.png'.format(forecast.sky))
    #div_plt_image.setAttribute('src', '/static/images/weather/{}.png'.format(forecast.sky))
